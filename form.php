...
<div class="container">
  <div class="row justify-content-center">
    <center><h5>We are eternally grateful to all our clients</h5></center>
    <!-- Left Column: Request a Quote Form -->
    <div class="col-lg-6 col-md-10 col-sm-12">
      <div class="quote-form p-4 shadow-lg rounded">
        <h2 class="text-center" style="font-size: 37px;">Have Any Queries?</h2>
...
<option data-countryCode="263" value="263">(+263) Zimbabwe</option>
            ...
            <div class="col-12 text-center">
              <div class="g-recaptcha brochure_form_captcha" data-sitekey="6Ld4VQcqAAAAALyJlo4IDoSKR6nGojx2DvOOMj"></div>
            </div>
            <div class="col-12 text-center mt-3">
<button type="submit" name="submit" class="contact-btn bg button-contactForm">Send Message</button>
</div>
          </div>
